          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-white/10 pb-6">
            <div>
              ...
              <p className="text-xl text-gray-400 font-light">
                Estadísticas y Proyecciones <span className="text-accent font-medium">2026</span>
              </p>
            </div>
            <div className="flex gap-8">
              <div className="text-right hidden md:block">
                <span className="block text-sm text-gray-500 uppercase tracking-widest">Total Teams</span>
              ...
              <div className="text-right hidden md:block border-l border-white/10 pl-8">
                <span className="block text-sm text-secondary uppercase tracking-widest">Advanced</span>
