            ...
            {configured === null ? (
                ...
                <>
                    ...
                    <div className="flex gap-1">
                        <button
                            ...
                            onClick={handleTest}
                            disabled={busy}
                            className="flex-1 px-2 py-1.5 bg-white/5 hover:bg-white/10 text-gray-300 text-[10px] font-bold rounded disabled:opacity-50"
                        >
                            Probar
                        </button>
                        <button
                            ...
                            onClick={handleClear}
                            disabled={busy}
                            className="px-2 py-1.5 bg-white/5 hover:bg-red-500/20 text-gray-500 hover:text-red-400 text-[10px] font-bold rounded disabled:opacity-50"
                ...
                <div className="space-y-1.5">
                    <input
                        ...
                        className="w-full px-2 py-1.5 bg-black/40 border border-white/10 rounded text-white text-[10px] font-mono"
                    />
                    <div className="flex gap-1">
                        <button
                            type="button"
                            ...
                            className="flex-1 px-2 py-1.5 bg-primary hover:bg-primary/90 text-white text-[10px] font-bold rounded disabled:opacity-50 flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                            ...
                            className="px-2 py-1.5 bg-white/5 hover:bg-white/10 text-gray-400 text-[10px] font-bold rounded"
                        >
                            Cancelar
                        </button>
                    </div>
                ...
                <button
                    ...
                    className="w-full px-2 py-1.5 bg-white/5 hover:bg-white/10 text-gray-300 text-[10px] font-bold rounded"
                >
                    Configurar webhook
                </button>
            )}
