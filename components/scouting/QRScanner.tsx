...
export default function QRScanner({ onScan, onClose }: QRScannerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-slate-900/90 flex flex-col items-center justify-center p-6">
            <button
                onClick={onClose}
            ...
            <div className="relative w-full max-w-sm aspect-square bg-slate-800 border-4 border-primary rounded-[2rem] overflow-hidden flex items-center justify-center">
            ...
            {error && (
                <div className="mt-8 px-6 py-3 bg-danger/10 text-danger font-bold rounded-xl border border-danger/20 shadow-sm text-sm">
                    {error}
                </div>
            )}
