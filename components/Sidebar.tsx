...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                className={clsx(
                    "fixed top-0 left-0 h-screen w-72 bg-[#0a0a0b]/95 backdrop-blur-xl border-r border-white/5 z-40 transition-transform duration-300 ease-in-out overflow-y-auto",
